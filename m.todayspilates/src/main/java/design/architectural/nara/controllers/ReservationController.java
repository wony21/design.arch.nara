...
import design.architectural.nara.domain.member.MemberService;
import design.architectural.nara.domain.reservation.member.MemberResrvService;

/**
 * 
 * 출결 및 예약API Controller (회원, 선생님, 관리자)
 * 
 * @Author : User
 * @Date : 2018. 6. 21.
 * @Version :
...
public class ReservationController extends BaseController {
	...
	@ResponseBody
	public List getMemberReservation(@RequestParam String storCd, @RequestParam String memberNo) {
	...
	@ResponseBody
	public List getDetailUseLesson(@RequestParam String storCd, @RequestParam String lsnCd,
			@RequestParam String memberNo, @RequestParam String lsnNo) {
		String compCd = SessionUtils.getCurrentUser().getCompCd();
	...
	@ResponseBody
	public List getMemberLessonSummary(@RequestParam String storCd, @RequestParam String memberNo) {
		String compCd = SessionUtils.getCurrentUser().getCompCd();
	...
	@ResponseBody
	public List getWeeklyLesson(@RequestParam String storCd,
			@RequestParam(defaultValue = "", required = false) String memberNm,
			@RequestParam(defaultValue = "", required = false) String empNo,
			@RequestParam(defaultValue = "", required = false) String rsvDt, @RequestParam String sttDt,
	...
	@ResponseBody
	public List getUserLessons(@RequestParam String storCd, @RequestParam(defaultValue = "") String memberNo,
	...
	public List getPersonalLesson(@RequestParam String storCd, @RequestParam String memberNm) {
		String compCd = SessionUtils.getCurrentUser().getCompCd();
	...
	@ResponseBody
	public List getWeeklyDetail(@RequestParam String storCd, @RequestParam(defaultValue = "") String memberNm,
			@RequestParam(defaultValue = "") String empNo, @RequestParam String sttDt, @RequestParam String endDt,
	...
	@ResponseBody
	public List getMemberLesson(@RequestParam String storCd, @RequestParam String memberNo,
	...
	@ResponseBody
	public List getMemberGroupLesson(@RequestParam String storCd, @RequestParam String memberNm) {
		String compCd = SessionUtils.getCurrentUser().getCompCd();
	...
	@ResponseBody
	public List getGroupLesson(@RequestParam String storCd, @RequestParam String schDt) {
		String compCd = SessionUtils.getCurrentUser().getCompCd();
	...
	@ResponseBody
	public List getGroupLessonView(@RequestParam String storCd, @RequestParam String schDt) {
		String compCd = SessionUtils.getCurrentUser().getCompCd();
	...
	@ResponseBody
	public List getGroupMembers(@RequestParam String storCd, @RequestParam(required = false) String memberNm) {
		String compCd = SessionUtils.getCurrentUser().getCompCd();
	...
	@ResponseBody
	public List getGroupSchedule(@RequestParam String storCd, @RequestParam String schMonth,
	 ...
	 * @auth : 선생님, 관리자
	 * @param requestParams [ { "lsnNm": "개인", "empNm": "노미리", "lsnTm": 1, "empNo":
	 *                      "00005", "lsnSeq": 4, "lsnUseCnt": 0, "compCd": "0001",
	 *                      "lsnNo": "002", "lsnCd": "01", "lsnCnt": 20, "storCd":
	 *                      "001", "memberNo": "00008", "rsvTm": "2000", "memberNm":
	 *                      "김주영", "dy": "금", "atndFg": "2", "rsvDt": "20180615",
	 *                      "lsnEdDt": "" } ]
	 * @return
	 */
	@ResponseBody
	 ...
	 * @auth : 선생님, 관리자
	 * @param requestParams [ { "compCd": "storCd": "memberNo": "lsnCd": "lsnNo":
	 *                      ------------------------ 여기까지가 key "empNo":선생님코드(화면에서
	 *                      선택된 값) "lsnTm":시간(화면에서 설정한 값 1.0, 1.5 등)
	 *                      "rsvDt":예약일(yyyyMMdd) "rsvTm":예약시간(HHmm) } ]
	 * @return
	 */
	@ResponseBody
	...
	@ResponseBody
	public List getCommon(@RequestParam(required = false) String groupCd) {
